...
function serializeValue(param) {
  if (typeof param === "number") {
    ...
    if (variant !== -908856609) {
      if (variant !== 3654863 && variant >= 848054398) {
        return $$Array.of_list(List.map(serializeValue, param[1]));
      } else {
        return param[1];
      }
    } else {
      ...
      List.iter((function (param) {
              dict[param[0]] = serializeValue(param[1]);
              return /* () */0;
            }), param[1]);
      return dict;
    }
...
function obj($staropt$star, $staropt$star$1, fields, name) {
  ...
  var self = [];
  Caml_obj.caml_update_dummy(self, /* Object */Block.variant("Object", 3, [/* record */Block.record([
              "name",
              "description",
              "fields",
              "implements"
...
var string = /* Scalar */Block.variant("Scalar", 0, [/* record */Block.record([
        "name",
        "description",
        "parse",
        "serialize"
...
var $$int = /* Scalar */Block.variant("Scalar", 0, [/* record */Block.record([
        "name",
        "description",
        "parse",
        "serialize"
...
var $$float = /* Scalar */Block.variant("Scalar", 0, [/* record */Block.record([
        "name",
        "description",
        "parse",
        "serialize"
